...
import TutorialIndex from '../pages/Tutorial/TutorialIndex';
import LabIndex from '../pages/Lab/LabIndex';
import EntertainmentIndex from '../pages/Entertainment/EntertainmentIndex';
...
export default new Router({
  ...
  routes: [
    ...
    {
      path: '/entertainment',
      name: 'EntertainmentIndex',
      component: EntertainmentIndex
    },
    {
      path: '/resume',
      name: 'Resume',
